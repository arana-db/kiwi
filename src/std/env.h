...
class FileLock : public kstd::noncopyable {
 public:
  FileLock() = default;
...
class WritableFile : public kstd::noncopyable {
 public:
...
class RWFile : public kstd::noncopyable {
 public:
  RWFile() = default;
  virtual ~RWFile();
...
class RandomRWFile : public kstd::noncopyable {
 public:
