...
mod tests {
    ...
    fn test_basic_cases() {
        ...
        assert_eq!(murmur3_32("The quick brown fox jumps over the lazy dog.", 0), 0xd5c48bfc);
        ...
        assert_eq!(murmur3_32("The quick brown fox jumps over the lazy dog.", 0x01), 0x846f6a36);
        ...
        assert_eq!(murmur3_32("The quick brown fox jumps over the lazy dog.", 0x2a), 0xc02d1434);
    }
